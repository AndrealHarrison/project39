...
final class Project39_Tests: XCTestCase {
    ...
    func testWordCountsAreCorrect() {
        ...
        XCTAssertEqual(playData.wordCounts["enemies"], 15, "enemies does not appear 15 times")
        XCTAssertEqual(playData.wordCounts["smother"], 2, "Mortal does not appear 2 times")
    }
